...
begin
 ...
 (*   try ClearPattab;
  ...
  UpdateDVTGraphArray;
  except ShowMessage('Exception 5: End');
  end;
end;

procedure TDataForm.ClearPattab;
var
  i, j : Integer;
begin
  for i := 1 to DBPattab.RowCount - 1 do
    for j := 1 to DBPattab.ColCount -1 do
      DBPattab.GridCells[j,i].IsEmpty;
end;
